...
public class KafkaMsgConsumer implements Runnable{
	...
	private Consumer<String, String> kfkaConsumer;
	public KafkaMsgConsumer(Consumer<String, String> kfkaConsumer) {
	...
	public void run() {
		...
		while(true) {
			...
			ConsumerRecords<String, String> consumerRecords = kfkaConsumer.poll(1000);
